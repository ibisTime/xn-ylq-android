...
{
    private static final String DIR_NAME = "yituCache";
    private static final int MAX_COUNT = 3 * 1024 * 1024;
    ...
    public String getAsString(String key) {
        ...
        String str = null;
        try {
            str = AppUtils.readFully(new InputStreamReader(inputStream, AppUtils.UTF_8));
        } catch (IOException e) {
            e.printStackTrace();
            try {
                inputStream.close();
    ...
    {
        put(key, AppUtils.bitmap2Bytes(bitmap));
    }
    ...
    public Bitmap getAsBitmap(String key)
    {
        ...
        return AppUtils.bytes2Bitmap(bytes);
    }
    ...
    {
        put(key, AppUtils.drawable2Bitmap(value));
    }
    ...
    public Drawable getAsDrawable(String key)
    {
        ...
        return AppUtils.bitmap2Drawable(AppUtils.bytes2Bitmap(bytes));
    }
    ...
    public boolean remove(String key)
    {
        try
        {
            key = AppUtils.hashKeyForDisk(key);
    ...
    public InputStream get(String key)
    {
        try
        {
            DiskLruCache.Snapshot snapshot = mDiskLruCache.get(AppUtils.hashKeyForDisk(key));
