 ...
 * ================================================
 */
public class ImagePreviewAdapter2 extends PagerAdapter implements PhotoViewAttacher.OnPhotoTapListener {

    private List<ImageInfo> imageInfo;
    private Context context;
    private View currentView;

    public ImagePreviewAdapter2(Context context, @NonNull List<ImageInfo> imageInfo) {
        super();
...
//                }).into(imageView);
    ...
    public void onPhotoTap(View view, float x, float y) {
        ((ImagePrviewActivity2) context).finishActivityAnim();
    }
}